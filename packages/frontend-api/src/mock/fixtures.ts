...
export const MOCK_ADDRESSES = {
  ...
  curveKernel: '0x9000000000000000000000000000000000000009',
...
function numberedPositionId(value: number): Bytes32 {
...
export const POSITIONS: PositionDetail[] = [
  ...
  {
    id: numberedPositionId(0x101),
    positionKey: numberedPositionId(0x102),
    strategyHash: numberedPositionId(0x103),
    policyHash: numberedPositionId(0x104),
    marketId: MARKET_ID,
    maker: MAKER_A,
    lifecycle: 'active',
    runtimeVersion: 4,
    ...
    buy: curve({
      ...
      alpha: '-7',
      initialReserve: '7500',
      availableReserve: '6700',
      yInt: '7200',
      progressBps: 694,
    }),
    sufficientlyBacked: true,
    lastUpdateBlock: MOCK_INDEXED_BLOCK - 3,
    encodingVersion: 1,
    salt: numberedPositionId(0x105),
    strategy: '0x4c4f4231' as Hex,
    baseBacking: backing(BASE_TOKEN, '3.9'),
    quoteBacking: backing(QUOTE_TOKEN, '6700'),
    createdAtBlock: MOCK_INDEXED_BLOCK - 190,
    createdTransaction: transactionHash('d'),
    warnings: [],
    meta: mockMeta(),
  },
  {
    id: numberedPositionId(0x201),
    positionKey: numberedPositionId(0x202),
    strategyHash: numberedPositionId(0x203),
    policyHash: numberedPositionId(0x204),
    marketId: MARKET_ID,
    maker: MAKER_A,
    lifecycle: 'active',
    runtimeVersion: 2,
    ...
    buy: curve({
      ...
      alpha: '18',
      initialReserve: '5200',
      availableReserve: '4680',
      yInt: '5000',
      progressBps: 640,
    }),
    sufficientlyBacked: true,
    lastUpdateBlock: MOCK_INDEXED_BLOCK - 5,
    encodingVersion: 1,
    salt: numberedPositionId(0x205),
    strategy: '0x4c4f4231' as Hex,
    baseBacking: backing(BASE_TOKEN, '2.75'),
    quoteBacking: backing(QUOTE_TOKEN, '4680'),
    createdAtBlock: MOCK_INDEXED_BLOCK - 120,
    createdTransaction: transactionHash('e'),
    warnings: [],
    meta: mockMeta(),
  },
]
